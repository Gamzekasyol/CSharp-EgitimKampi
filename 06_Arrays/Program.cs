namespace array_06
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] names = { "Ali", "Fatma", "Merve", "Kamil" };
            int index = Array.IndexOf(names, "Merve");
            Console.WriteLine(index);


            int[] numbers = { 10051, 258, 38, 45, 1, 45, 89, 25};
            ...
            Console.WriteLine("Büyük sayı: " + maxnum + " Küçük sayı: " + minnum);


            Console.Write("Max sayı: " + numbers.Max() + " Min sayı: " + numbers.Min());
            Console.WriteLine();
